    ...
    <div>
      <section className='flex flex-col md:flex-row justify-between p-5 items-center gap-10'>
        <div className='text-center md:text-left'>
          <h1 className='text-[28px] md:text-[40px] font-bold mt-[15px] text-[#ff9560]'>
